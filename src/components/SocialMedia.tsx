...
export const socialMediaProfiles = [
  {
    title: 'LinkedIn',
    href: 'https://www.linkedin.com/company/logic-leaps/',
    icon: LinkedInIcon,
  },
  {
    title: 'Instagram',
    href: 'https://www.instagram.com/logicleaps/',
    icon: InstagramIcon,
  },
  { title: 'GitHub', href: 'https://github.com/LogicLeaps', icon: GitHubIcon },
  {
    title: 'Dribbble',
    href: 'https://dribbble.com/LogicLeaps',
    icon: DribbbleIcon,
  },
]
